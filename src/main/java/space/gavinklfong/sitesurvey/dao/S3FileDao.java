...
public class S3FileDao {
    ...
    public List<String> listItems(String bucketName) {
        return listItems(bucketName, "");
    }

    public List<String> listItems(String bucketName, String prefix) {
    ...
    private Map<String, String> retrieveMetadata(String bucketName, String itemKey) {
    ...
    private Map<String, String> retrieveTags(String bucketName, String itemKey) {
    ...
    public URL generatePresignedUrl(String bucketName, String itemKey) {

        Map<String, String> metadata = retrieveMetadata(bucketName, itemKey);
    ...
    @SneakyThrows
    public void uploadItem(String bucketName, String itemKey, String filename, Map<String, String> metadata, MultipartFile file) {
    ...
    public byte[] downloadItemData(String bucketName, String itemKey) {
